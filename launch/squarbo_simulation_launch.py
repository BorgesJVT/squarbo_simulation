...
def generate_launch_description():
    ...
    start_squarbo_standalone_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
                os.path.join(get_package_share_directory('squarbo_gazebo'), 'spawn_squarbo.launch.py')),
    ...
    ld.add_action(start_squarbo_standalone_cmd)
